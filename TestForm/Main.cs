...
namespace Elan.TestForm
{
	...
	public class MainForm : Form
	{
		...
		private void InitializeComponent()
		{
            ...
            this.designer1 = new Elan.UserControls.Designer();
            ...
            this.openFileMenuItem.Click += new System.EventHandler(this.OpenFileMenuClick);
            // 
            // saveFileMenuItem
            // 
            ...
            this.menuItem5.Text = "Сохранить в файл в БД";
            // 
            // menuItem6
            // 
            this.menuItem6.Index = 6;
            this.menuItem6.Text = "Сохранить в файл в БД как...";
            // 
            // menuItem7
            // 
            ...
            this.mnuAbout.Click += new System.EventHandler(this.AboutMenuItemClick);
            // 
            // panel1
            // 
            ...
            this.designer1.ElementClick += new Elan.UserControls.Designer.ElementEventHandler(this.designer1_ElementClick);
            this.designer1.ElementMouseDown += new Elan.UserControls.Designer.ElementMouseEventHandler(this.designer1_ElementMouseDown);
            this.designer1.ElementMouseUp += new Elan.UserControls.Designer.ElementMouseEventHandler(this.designer1_ElementMouseUp);
            this.designer1.ElementMoving += new Elan.UserControls.Designer.ElementEventHandler(this.designer1_ElementMoving);
            this.designer1.ElementMoved += new Elan.UserControls.Designer.ElementEventHandler(this.designer1_ElementMoved);
            this.designer1.ElementResizing += new Elan.UserControls.Designer.ElementEventHandler(this.designer1_ElementResizing);
            this.designer1.ElementResized += new Elan.UserControls.Designer.ElementEventHandler(this.designer1_ElementResized);
            this.designer1.ElementConnecting += new Elan.UserControls.Designer.ElementConnectEventHandler(this.designer1_ElementConnecting);
            this.designer1.ElementConnected += new Elan.UserControls.Designer.ElementConnectEventHandler(this.designer1_ElementConnected);
            this.designer1.ElementSelection += new Elan.UserControls.Designer.ElementSelectionEventHandler(this.designer1_ElementSelection);
		...
		private void OpenFromFile()
		{
			...
			{
				designer1.OpenFile(openFileDialog.FileName);
			}
		}     
	    private void SaveToFile()
        {
            ...
            {
                designer1.Save(CurrentFileName);
            }
            else
            {
                SaveToFileAs();
        ...
        private void DbConnectionMenuItemClick(object sender, EventArgs e)
        {
            try
            {
                ...
                if (DataConnectionDialog.Show(dialog) == DialogResult.OK)
                {
                    ...
                    MessageBox.Show("Подключение к БД успешно задано", "Elan", MessageBoxButtons.OK, MessageBoxIcon.Information);
                }
            }
            catch (Exception ex)
            {
                MessageBox.Show(ex.ToString(), "Elan", MessageBoxButtons.OK, MessageBoxIcon.Information);
            }
        }

        private void AboutMenuItemClick(object sender, System.EventArgs e)
		{
		...
		private void toolBar1_ButtonClick(object sender, System.Windows.Forms.ToolBarButtonClickEventArgs e)
		{
			...
			if (btn == "Open") OpenFromFile();
			if (btn == "Save") SaveToFileAs();
        ...
        {
            var documents = DataBaseManager.GetDocuments();
